...
public class Playing_lvl3 extends BaseState implements GameStateInterface {
    ...
    public Playing_lvl3(Game game) {
        super(game);

        aSetter.setObject_lvl3();

        // Initialize Tilemap
        tilemap = new Tilemap(mapSpriteSheet, 3);
    ...
    public void update() {
        ...
        if (obj[3] != null) {
            int x = 7 * TILE_WIDTH_PIXELS;
            int y = 27 * TILE_HEIGHT_PIXELS;
